...
<main class="static-main">
  <article class="about-content guide-content">
    ...
    <div class="guide-related">
      ...
      <a href="/guide/technical-indicators">기술적 지표 가이드</a>
      <a href="/guide/supply-demand">수급 읽는 법</a>
      ...
      <a href="/guide/holidays">휴장일 가이드</a>
      <a href="/glossary">주식 용어집</a>
      <a href="/chart">전종목 차트 →</a>
    </div>
  </article>
</main>
...
# ──────────────────────────────────────────────────────
HOLIDAY_BODY = """
<h2>📅 한국 주식 시장 휴장일 완벽 가이드</h2>
<p class="lead">
  한국 주식 시장(KOSPI · KOSDAQ)은 한국거래소(KRX)의 거래일 캘린더에 따라 운영됩니다.
  주말과 공휴일은 휴장이 기본이지만, "임시 휴장", "조기 폐장", "동시호가 없는 거래일" 등
  알아두지 않으면 놓치기 쉬운 변수도 있습니다. 이 가이드는 거래일·휴장일 결정 원칙부터
  연중 주요 휴장 패턴, 단축 거래일 운영 방식, 그리고 휴장 전후 매매 전략의 주의점까지
  실전 관점에서 정리합니다.
</p>

<section>
  <h3>1. 정규 거래 시간과 동시호가</h3>
  <p>
    한국거래소의 정규 거래는 <strong>09:00~15:30</strong> (KST). 시작 전 동시호가는 08:00~09:00,
    종료 동시호가는 15:20~15:30 입니다. 시간외 단일가는 16:00~18:00 으로 별도 운영됩니다.
    동시호가 시간엔 호가는 받지만 체결은 한 번에 단일가로 결정되어, 시가/종가가 결정됩니다.
  </p>
</section>

<section>
  <h3>2. 한국거래소가 정한 정기 휴장일</h3>
  <ul>
    <li><strong>토요일·일요일</strong> 매주 휴장</li>
    <li><strong>법정 공휴일</strong>: 신정·설날·삼일절·어린이날·석가탄신일·현충일·광복절·추석·개천절·한글날·성탄절</li>
    <li><strong>대체공휴일</strong>: 일요일과 겹친 명절·어린이날 등이 월요일로 대체될 때 그 월요일도 휴장</li>
    <li><strong>근로자의 날(5월 1일)</strong>: 한국거래소 직원이 근로자에 해당해 주식시장도 휴장</li>
    <li><strong>연말 마지막 거래일 다음 영업일</strong>: 12월 31일은 연말 폐장 처리, 다음 해 1월 첫 영업일이 새 거래일</li>
  </ul>
  <div class="callout"><strong>참고:</strong> 한국거래소는 매년 12월 초 다음 해 거래일 캘린더를 공식 발표합니다. 임시 휴장(특별 행사 등)은 예외적으로 추가 발표.</div>
</section>

<section>
  <h3>3. 단축 거래·조기 폐장 케이스</h3>
  <h4>새해 첫 거래일</h4>
  <p>매년 1월 첫 영업일은 <strong>10:00 시작</strong>으로 단축 운영됩니다. 종가 결정은 평소처럼 15:30. 시간외도 정상.</p>
  <h4>설·추석 직전 거래일</h4>
  <p>대체로 정상 운영이지만, 종종 결제일 조정으로 거래량이 줄어드는 경향. 시간외 거래는 명절 연휴 동안 정지.</p>
</section>

<section>
  <h3>4. 휴장이 가격·수급에 미치는 영향</h3>
  <ul>
    <li><strong>주말/명절 직전</strong>: 매수보다 매도가 우세한 경향 — 연휴 동안의 해외 시장 변동 리스크를 회피하려는 심리</li>
    <li><strong>휴장 직후 첫 거래일</strong>: 해외 시장에서 누적된 변동이 반영돼 갭 발생 빈도 ↑</li>
    <li><strong>외국인 매매 패턴</strong>: 한국 휴장 중에도 미국·아시아 시장은 열리므로, 글로벌 매크로 변화가 한국에 한꺼번에 반영</li>
    <li><strong>결제일 (T+2)</strong>: 매매 체결 후 2영업일 뒤 결제. 휴장 사이에 결제일이 끼면 자금 묶임 기간이 길어짐</li>
  </ul>
</section>

<section>
  <h3>5. 휴장 전후 매매 시 주의점</h3>
  <ol>
    <li><strong>결제일 계산</strong>: 매수일 +2영업일 = 결제일. 명절 전 매수는 결제 지연을 감안</li>
    <li><strong>배당락일</strong>: 결산 배당받으려면 <em>배당기준일 2영업일 전</em>까지 매수해야 함</li>
    <li><strong>권리락일</strong>: 무상증자·액면분할 등 권리 발생을 반영한 가격 조정. 휴장과 겹치면 더 헷갈림</li>
    <li><strong>임시 변동성 완화장치(VI)</strong>: 휴장 직후 시가 갭 변동 클 때 자주 발동</li>
  </ol>
</section>
...
<section>
  <h3>6. 미국 시장과의 시차</h3>
  <p>
    미국 동부 시간(EDT/EST) 기준 정규장 09:30~16:00 = 한국 시간 22:30/23:30 ~ 다음날 05:00/06:00.
    한국 휴장 중에도 미국 장이 열리는 경우, 다음 거래일 한국 시장의 시가는 미국 변동을 그대로 반영합니다.
    그래서 일·월요일 갭이 자주 나타나고, 명절 연휴 직후엔 변동폭이 더 큽니다.
  </p>
</section>
...
<section>
  <h3>마치며</h3>
  <p>
    휴장일은 단순히 "쉬는 날"이 아니라 매매·결제·세금 계산 모두에 영향을 주는 중요한 변수입니다.
    매년 12월 한국거래소가 발표하는 다음 해 캘린더를 확인해두고, 명절·연말 직전에는 결제·배당락 일정을
    한 번 더 체크하시기 바랍니다. 세콤달.콤 주식맛집의 차트는 영업일만 표시되어, 휴장 다음 거래일은
    바로 직전 거래일과 캔들이 인접해 그려집니다.
  </p>
</section>
"""
...
# ──────────────────────────────────────────────────────
PER_PBR_BODY = """
<h2>💸 PER · PBR 의 함정 — 저평가 신호 vs 가치 함정</h2>
<p class="lead">
  PER(주가수익비율) 과 PBR(주가순자산비율) 은 가치 평가의 출발점이지만, 단독으로 쓰면 오해하기 쉬운 지표입니다.
  PER 5배가 무조건 저평가는 아니고, PBR 0.7배가 무조건 매력적인 것도 아닙니다. 이 가이드는 두 지표의 정확한
  의미, 산업별 적정 범위, 그리고 저평가처럼 보이지만 사실은 "가치 함정(value trap)" 인 케이스를 분류해 정리합니다.
</p>

<section>
  <h3>1. PER 다시 읽기</h3>
  <p>PER = 주가 / 주당순이익(EPS). "현재 이익이 1년 동안 그대로 유지된다고 가정할 때, 투자금을 회수하는 데 걸리는 햇수"로 해석할 수 있습니다.</p>
  <ul>
    <li><strong>PER 10</strong>: 현 이익 10년이면 본전</li>
    <li><strong>PER 30</strong>: 현 이익 30년 — 보통 성장 기대가 가격에 반영됐다는 뜻</li>
    <li><strong>PER 5 이하</strong>: 의심 신호 — 시장이 미래 이익이 줄거나 사라질 거라 보고 있을 수 있음</li>
  </ul>
</section>

<section>
  <h3>2. 산업별 적정 PER 차이</h3>
  <ul>
    <li><strong>금융·유틸리티</strong>: 10~12배 이내가 일반적. 성장 제한적·배당 안정.</li>
    <li><strong>제조·에너지·소재</strong>: 8~15배 — 경기 사이클 영향 큼.</li>
    <li><strong>IT·바이오·플랫폼</strong>: 30~80배 흔함 — 미래 성장 프리미엄.</li>
    <li><strong>리츠·투자회사</strong>: 별도 평가지표(NAV, 배당수익률) 우선.</li>
  </ul>
  <div class="callout"><strong>비교 원칙:</strong> "삼성전자 PER 10" 과 "네이버 PER 30" 을 직접 비교하지 마세요. 같은 업종 내 평균과 비교해야 의미가 있습니다.</div>
</section>

<section>
  <h3>3. PER 함정 — "낮은데 왜 이래?" 케이스</h3>
  <ol>
    <li><strong>일회성 이익 효과</strong>: 자산매각·세금환급 등 일회성 이익으로 EPS 가 일시 상승 → PER 이 낮아 보이지만 다음 분기에 정상화되며 PER 급등.</li>
    <li><strong>구조조정 직전 산업</strong>: 사양산업의 마지막 호황 — 이익은 좋지만 시장은 미래 감소를 미리 반영.</li>
    <li><strong>회계 이슈</strong>: 부채·우발채무·소송 비용이 미반영. 표면 이익이 부풀려진 상태.</li>
    <li><strong>지주회사 PER</strong>: 자회사 이익을 지분법으로 합산하면 연결 PER 이 낮아 보이지만, 실제 지주회사 자체 현금흐름은 다를 수 있음.</li>
  </ol>
</section>

<section>
  <h3>4. PBR 다시 읽기</h3>
  <p>PBR = 주가 / 주당순자산(BPS). "장부가치 대비 시장가치 배수". PBR 1배는 "장부가와 시장가가 같다", 0.7배는 "장부가치보다 30% 싸게 거래된다"는 뜻입니다.</p>
  <ul>
    <li><strong>PBR &lt; 1</strong>: 청산가치보다 시장가가 낮음 — 표면적 저평가, 그러나 이유가 있을 가능성</li>
    <li><strong>PBR 1~2</strong>: 일반적 범위</li>
    <li><strong>PBR &gt; 5</strong>: 무형자산·브랜드 가치가 큰 IT/바이오 — 장부가만으론 평가 어려움</li>
  </ul>
</section>

<section>
  <h3>5. PBR 함정 — 가치 함정 (Value Trap)</h3>
  <ol>
    <li><strong>장부가의 질</strong>: 부동산이 장부가에 시가가 아닌 매입가로 잡혀 있을 수도, 거꾸로 회수 어려운 매출채권이 자산으로 부풀려져 있을 수도.</li>
    <li><strong>ROE 수준</strong>: PBR 0.5라도 ROE 가 1% 이하면 자본을 효율적으로 쓰지 못한다는 뜻 → 시장이 정당하게 할인 중.</li>
    <li><strong>구조적 사양산업</strong>: 자산은 많지만 미래 현금흐름이 줄어드는 업종 (예: 일부 전통 미디어).</li>
    <li><strong>주주환원 부재</strong>: 자본이 쌓여 있어도 배당·자사주 매입 없으면 시장은 그 자본을 평가하지 않음.</li>
  </ol>
</section>

<section>
  <h3>6. 두 지표를 함께 — PEG·ROE 보완</h3>
  <p>PER 과 PBR 의 한계를 보완하려면 다음 두 지표를 함께 보는 것이 좋습니다.</p>
  <ul>
    <li><strong>PEG (PER / 이익성장률)</strong>: PER 30 이지만 이익이 매년 50% 성장 중이면 PEG 0.6 — 오히려 저평가</li>
    <li><strong>ROE</strong>: PBR 의 정당성 평가 — ROE 가 높으면 PBR 이 1 이상이라도 합리적</li>
    <li>워런 버핏 류 가치투자자들은 <strong>"높은 ROE × 합리적 PBR"</strong> 조합을 선호</li>
  </ul>
</section>
...
<section>
  <h3>마치며</h3>
  <p>
    PER · PBR 은 출발점이지 결승선이 아닙니다. 같은 PER 10 이라도 산업·이익 구조·자본 효율성에 따라
    매력적일 수도, 함정일 수도 있습니다. 세콤달.콤 주식맛집의 종목 모달에 표시되는 PER · PBR 은
    Naver Finance 의 최신 분기 기준이며, 단독 판단보다 같은 업종 비교 + ROE 함께 보시기를 권합니다.
  </p>
</section>
"""
...
# ──────────────────────────────────────────────────────
FORINST_BODY = """
<h2>🌐 외국인 vs 기관 — 매매 패턴 차이와 실전 활용</h2>
<p class="lead">
  한국 주식 시장에서 "외국인이 사면 오른다, 기관이 팔면 빠진다" 는 표현이 자주 쓰이지만, 실제로는 두 주체의
  매매 동기·시간대·종목 선호가 다릅니다. 이 가이드는 외국인·기관 매매의 본질적 차이, 종목별로 어느 쪽 영향이
  더 큰지 가늠하는 법, 그리고 두 흐름이 엇갈릴 때의 해석을 정리합니다.
</p>

<section>
  <h3>1. 누가 "외국인"인가</h3>
  <p>
    외국 국적 보유자(개인 + 기관) 의 매매 합. 실제로는 글로벌 자산운용사·헤지펀드·국부펀드·외국계 ETF·MSCI 패시브 자금이 큰 비중.
    한국 시장에서는 외국인 비중이 KOSPI 시가총액의 30~35% 수준으로, 가격 결정력이 큽니다.
  </p>
  <h4>외국인 매매의 동기</h4>
  <ul>
    <li><strong>글로벌 매크로</strong>: 달러 강·약, 신흥국 배분, 한국 채권금리</li>
    <li><strong>지수 패시브</strong>: MSCI 한국 지수 종목 변경 시 자동 매매</li>
    <li><strong>섹터 베팅</strong>: 반도체·자동차·바이오 테마 단위 매수</li>
    <li><strong>환차익</strong>: 원/달러 환율 기대 변화도 매매 동기</li>
  </ul>
</section>
...
<section>
  <h3>2. 누가 "기관"인가</h3>
  <p>
    한국 국적의 자산운용사·연기금·보험사·은행·증권사 자기매매 등을 포함. 시장 구조상 외국인 다음으로 큰 손.
    특히 국민연금(NPS) 의 자산 배분 정책 변화는 한국 증시 단기 변동성을 좌우할 정도.
  </p>
  <h4>기관 매매의 동기</h4>
  <ul>
    <li><strong>펀드 환매·설정</strong>: 개인 투자자의 펀드 매수·환매 흐름 따라 강제 매매</li>
    <li><strong>분기말·연말</strong>: 윈도우 드레싱(평가 효과를 위해 강한 종목 매수)</li>
    <li><strong>연기금 자산배분</strong>: 주식 비중 조정에 따른 대규모 매매</li>
    <li><strong>액티브 운용</strong>: 펀드매니저의 종목 분석 결과 반영</li>
  </ul>
</section>

<section>
  <h3>3. 매매 시간대·종목 차이</h3>
  <ul>
    <li><strong>외국인</strong>: 09:00~10:00 + 14:30~15:30 집중. 동시호가에서 큰 주문이 자주 등장. 대형주 비중 높음.</li>
    <li><strong>기관</strong>: 시간 분산이 외국인보다 큼. 중·소형주에서도 영향력 가짐. 분기말·연말 거래량 급증 패턴.</li>
    <li><strong>코스피200 종목</strong>: 외국인·기관 비중 모두 높음 → 두 흐름 모두 봐야</li>
    <li><strong>코스닥 중·소형</strong>: 외국인 영향 작음 → 기관·개인 흐름이 핵심</li>
  </ul>
</section>

<section>
  <h3>4. 두 흐름의 4가지 조합</h3>
  <ol>
    <li><strong>외인 매수 + 기관 매수</strong>: 가장 강한 매수 신호. 동조 추세 길게 이어질 가능성</li>
    <li><strong>외인 매수 + 기관 매도</strong>: 견해 엇갈림. 외국인이 옳으면 추세 지속, 기관이 옳으면 단기 조정</li>
    <li><strong>외인 매도 + 기관 매수</strong>: 환율 이슈로 외국인이 빠지지만 국내 기관은 매력 인식. 변동성 큼</li>
    <li><strong>외인 매도 + 기관 매도</strong>: 명확한 약세. 추세 반전까지 시간 필요</li>
  </ol>
</section>
...
<section>
  <h3>5. 실전 활용 팁</h3>
  <h4>가격과의 교차 검증</h4>
  <p>가격 횡보 + 외국인 누적 우상향 = <strong>매집 가능성</strong>. 가격 하락 + 외국인 매수 = 큰손이 사 모으는 신호일 수 있음.</p>
  <h4>시장 전체와 종목 분리</h4>
  <p>"외국인이 KOSPI 1조 매도" 와 "내 종목 외국인 100억 매수" 는 별개. 종목 단위 수급도 함께 확인.</p>
  <h4>지수 변경 이벤트</h4>
  <p>MSCI 정기 리뷰(5월·11월), KOSPI200 정기변경(6월·12월) 직전·직후 외국인 매매 급증. 단기 변동성 주의.</p>
</section>

<section>
  <h3>6. 흔한 함정</h3>
  <ul>
    <li><strong>"외국인은 똑똑하다"</strong> — 외국인도 손실 봅니다. 외국인 매수가 정답이 아님</li>
    <li><strong>프로그램 매매 분류</strong>: 외국인 안에도 차익·비차익이 섞여 있어, 차익거래성 매도는 의미 약함</li>
    <li><strong>"개인은 항상 늦다"</strong> — 사실은 회계적 항등식. 외인+기관+개인 = 0 이라 누군가 사면 누군가는 팔아야</li>
    <li><strong>지연 데이터</strong>: 일반 공개되는 수급은 장 마감 후 집계. 실시간이 아님</li>
  </ul>
</section>
...
<section>
  <h3>마치며</h3>
  <p>
    수급 데이터는 가격 차트만 보는 것보다 훨씬 입체적인 정보를 줍니다. 다만 "외국인 = 옳다" 같은 단순화는 위험.
    종목·시장·이벤트 맥락을 함께 봐야 의미가 살아납니다. 세콤달.콤 주식맛집은 60일 누적 외국인·기관 순매수를
    가격 차트와 함께 표시해 빠른 비교가 가능합니다.
  </p>
</section>
"""
...
# ──────────────────────────────────────────────────────
PREFERRED_BODY = """
<h2>🟡 우선주 vs 보통주 — 무엇을 사야 할까</h2>
<p class="lead">
  같은 회사인데 종목이 두 개 보일 때가 있습니다 — 예: 삼성전자(005930) 와 삼성전자우(005935).
  앞쪽이 보통주, 뒤쪽이 우선주입니다. 이 가이드는 두 주식의 차이, 가격 차이가 생기는 이유,
  그리고 어떤 경우에 우선주가 더 유리한지 정리합니다.
</p>

<section>
  <h3>1. 보통주 (Common Stock)</h3>
  <ul>
    <li><strong>의결권</strong>: 주주총회에서 투표 가능</li>
    <li><strong>배당</strong>: 회사 결정에 따라 받음 (의무 아님)</li>
    <li><strong>유동성</strong>: 거래량 많고 시가총액 큼</li>
    <li><strong>잔여재산 분배</strong>: 청산 시 채권자 + 우선주 다음 순위</li>
  </ul>
</section>

<section>
  <h3>2. 우선주 (Preferred Stock)</h3>
  <ul>
    <li><strong>의결권 없음</strong>: 회사 의사결정에 영향 못 미침</li>
    <li><strong>배당 우선권</strong>: 보통주보다 먼저 + 종종 더 높은 배당</li>
    <li><strong>잔여재산 우선권</strong>: 청산 시 보통주보다 먼저 분배</li>
    <li><strong>종목코드</strong>: 끝자리가 5/7/9 또는 K (예: 005935 삼성전자우, 0050K0 LG화학우)</li>
  </ul>
  <div class="callout"><strong>참고:</strong> 한국 우선주 대부분은 "참가적·누적적"이 아닌 단순형. 약속된 배당 못 받아도 누적 청구권 없음.</div>
</section>

<section>
  <h3>3. 가격 차이는 왜 생기나</h3>
  <p>
    보통주와 우선주 가격은 거의 항상 차이가 납니다. 보통은 우선주가 보통주보다 <strong>10~30% 저렴</strong>합니다.
    이를 "우선주 디스카운트(괴리율)" 라고 부릅니다.
  </p>
  <h4>괴리 발생 원인</h4>
  <ol>
    <li><strong>의결권 가치</strong>: 경영권 분쟁이나 안건 통과 시 의결권은 실질 가치를 가짐 → 보통주에 프리미엄</li>
    <li><strong>유동성 차이</strong>: 우선주는 거래량 적어 매수·매도 시 슬리피지 큼 → 할인</li>
    <li><strong>인덱스 편입</strong>: KOSPI200 등 주요 지수에 보통주만 들어가는 경우 많음 → 패시브 자금이 보통주 집중</li>
    <li><strong>외국인 매매</strong>: 외국인 비중이 우선주에서 더 낮음 → 수급 차이</li>
  </ol>
</section>

<section>
  <h3>4. 우선주가 더 유리한 경우</h3>
  <ul>
    <li><strong>고배당 추구</strong>: 같은 회사 우선주의 배당수익률이 보통주보다 1~3%p 높은 경우 자주 있음</li>
    <li><strong>장기 보유 + 의결권 무관심</strong>: 의결권을 행사할 일 없는 개인이라면 디스카운트만큼 매력</li>
    <li><strong>괴리율 일시 확대 시</strong>: 평균 대비 우선주 디스카운트가 비정상적으로 벌어지면 회귀 매매 기회</li>
  </ul>
</section>

<section>
  <h3>5. 보통주가 더 유리한 경우</h3>
  <ul>
    <li><strong>경영권 분쟁·인수합병 가능성</strong>: 의결권 프리미엄이 부각되며 보통주 가격 급등 가능</li>
    <li><strong>지수 편입 종목</strong>: 패시브 자금 유입 효과로 장기적으로 우월</li>
    <li><strong>유동성 중요</strong>: 단기 매매·큰 자금일수록 보통주의 깊은 호가창이 유리</li>
  </ul>
</section>
...
<section>
  <h3>6. 흔한 우선주 함정</h3>
  <ul>
    <li><strong>거래량 급증 + 가격 급등</strong>: 우선주는 시총 작아 작전 대상이 되기 쉬움. 무작정 따라 사면 위험</li>
    <li><strong>괴리율 좁혀짐</strong>: 평균 30% → 갑자기 5% 로 좁혀지면 우선주가 단기에 30~40% 급등 — 장점이지만 다음엔 다시 벌어질 수 있음</li>
    <li><strong>1우/2우 구분</strong>: 일부 회사는 "1우B(누적적·전환)" 와 "2우" 등 다른 종류 우선주 발행. 권리 차이 있음</li>
  </ul>
</section>

<section>
  <h3>7. 한국 시장의 특이 사례</h3>
  <p>
    한국에서 가장 유명한 케이스는 <strong>현대차2우B</strong> — 채권형 우선주로 분기 배당이 약속돼 있어
    일반 우선주보다 가격이 안정적입니다. 또 <strong>삼성전자우</strong> 는 시총이 워낙 커서 우선주 중 거래량이
    가장 많고, 외국인 보유 비중도 높습니다. 종목별로 우선주 특성이 크게 다르니 일률적으로 보지 마세요.
  </p>
</section>
...
<section>
  <h3>마치며</h3>
  <p>
    우선주는 "배당 위주 장기 보유" 라면 매력적인 선택지입니다. 다만 의결권 부재·낮은 유동성·인덱스 비편입의 한계는
    이해하고 시작해야 합니다. 세콤달.콤 주식맛집은 보통주·우선주를 별도 종목으로 표시하며, 종목명 끝의 "우" 표기로
    쉽게 구분할 수 있습니다.
  </p>
</section>
"""
...
# ──────────────────────────────────────────────────────
MARKET_METRICS_BODY = """
<h2>📊 시가총액 · 거래대금 · 거래량 — 셋의 차이와 활용법</h2>
<p class="lead">
  주식 차트나 뉴스를 보면 거래량 100만주, 거래대금 5,000억원, 시가총액 70조원 같은 숫자가 자주 등장합니다.
  세 지표는 비슷해 보이지만 의미·활용이 다릅니다. 이 가이드는 정확한 정의, 어느 상황에 어느 지표를 봐야 할지,
  그리고 흔히 빠지는 해석 오류를 정리합니다.
</p>

<section>
  <h3>1. 정의</h3>
  <ul>
    <li><strong>시가총액</strong> = 발행주식수 × 현재 주가. 회사의 시장가치 단순화.</li>
    <li><strong>거래량</strong> = 해당 기간 동안 매매된 주식 수 (단위: 주).</li>
    <li><strong>거래대금</strong> = 거래량 × 평균 거래가격 (단위: 원). 자금이 얼마나 오갔는지.</li>
  </ul>
  <div class="callout">"거래량 100만주" 와 "거래대금 100억원" 은 종목 가격 수준에 따라 차이가 큽니다. 5만원짜리 100만주 = 500억원, 5,000원짜리 100만주 = 50억원. 직접 비교 시 거래대금이 더 의미 있습니다.</div>
</section>

<section>
  <h3>2. 시가총액 — 회사 규모 비교</h3>
  <p>회사 크기·시장 영향력 가늠. KOSPI 시총 1위 삼성전자, 2위 SK하이닉스 같은 식으로 줄 세우는 데 사용.</p>
  <h4>유용한 활용</h4>
  <ul>
    <li><strong>대형주·중소형주 분류</strong>: 일반적으로 5조원 이상 = 대형, 5천억~5조 = 중형, 5천억 이하 = 소형</li>
    <li><strong>지수 편입 가늠</strong>: KOSPI200 은 대체로 시총 상위 200개 종목 중심</li>
    <li><strong>유사 기업 비교</strong>: 같은 업종 내 비교 — "이 회사가 업계에서 어느 정도 위치인가"</li>
  </ul>
  <h4>주의점</h4>
  <ul>
    <li>시가총액은 매일 변함. 어제 1위가 오늘 2위가 되기도</li>
    <li>지주회사·자회사가 따로 상장된 경우 합산 효과 존재</li>
  </ul>
</section>

<section>
  <h3>3. 거래량 — 관심도와 변동성</h3>
  <p>그날 거래된 주식 수. 종목 자체의 관심도·변동성을 가늠.</p>
  <h4>의미 있는 패턴</h4>
  <ul>
    <li><strong>거래량 평소 대비 3배 ↑</strong>: 호재·악재 또는 주목할 이벤트 발생 가능성. 가격이 함께 움직이면 해석 명확</li>
    <li><strong>거래량 ↑ + 가격 ↑</strong>: 추세 강화 신호 (매수 압력 우위)</li>
    <li><strong>거래량 ↑ + 가격 ↓</strong>: 매도 압력 — 약세 신호일 수 있음</li>
    <li><strong>거래량 ↓ + 가격 횡보</strong>: 관심 낮음 — 큰 움직임 잠시 없을 가능성</li>
  </ul>
  <h4>한계</h4>
  <p>같은 100만주 거래라도 종목별 시총·발행주식수가 다르면 임팩트가 다름. 100만주가 발행주식의 0.1% 인 종목과 10% 인 종목은 의미가 천지차이.</p>
</section>

<section>
  <h3>4. 거래대금 — 자금 흐름과 변동성 비교</h3>
  <p>실제 돈이 얼마나 오갔는지. 종목 간 비교에 가장 적합.</p>
  <h4>유용한 활용</h4>
  <ul>
    <li><strong>일별 거래대금 상위</strong>: 그날 자금이 가장 활발히 움직인 종목 — 단기 트레이더의 관심 대상</li>
    <li><strong>유동성 평가</strong>: 대량 매매 가능 여부 — 거래대금 적은 종목은 슬리피지 큼</li>
    <li><strong>외국인·기관 매매 비중</strong>: 거래대금 대비 비중으로 봐야 의미 정확</li>
  </ul>
</section>

<section>
  <h3>5. 세 지표의 관계와 회전율</h3>
  <p><strong>회전율 = 거래량 / 발행주식수</strong>. 그날 발행 주식 중 몇 %가 손바뀜했는지.</p>
  <ul>
    <li><strong>회전율 1% 미만</strong>: 안정적·관심 낮음</li>
    <li><strong>회전율 5% 이상</strong>: 활발한 매매 — 변동성 큼</li>
    <li><strong>회전율 20% 이상</strong>: 단타 자금 집중 — 작전 의심 또는 큰 이벤트</li>
  </ul>
  <p><strong>거래대금 / 시가총액</strong> 비율도 비슷하게 활용 가능 — 회사 규모 대비 그날 자금 활성도.</p>
</section>

<section>
  <h3>6. 흔한 해석 오류</h3>
  <ul>
    <li><strong>"거래량 늘었으니 좋은 신호"</strong> — 가격 방향과 함께 봐야 함. 거래량 + 가격 하락은 매도 신호</li>
    <li><strong>시총만 보고 큰 회사라 안전</strong> — 시총은 가격 변동에 따라 빠르게 변함. 펀더멘털과 별개</li>
    <li><strong>거래량과 거래대금 혼용</strong> — 비교 시 종목별 가격 차이를 놓치기 쉬움. 거래대금이 더 보편적</li>
    <li><strong>회전율 높은 게 무조건 좋다</strong> — 안정적 가치투자에는 오히려 회전율 낮은 게 유리할 수 있음</li>
  </ul>
</section>
...
<section>
  <h3>마치며</h3>
  <p>
    세 지표는 각자 다른 질문에 답합니다. "회사가 얼마나 큰가?" → 시가총액. "오늘 활발했나?" → 거래량/거래대금.
    "자금이 회전했나?" → 회전율. 함께 보면 종목의 실제 상태를 입체적으로 파악할 수 있습니다.
    세콤달.콤 주식맛집의 차트는 시가총액·거래량·거래대금을 모두 표시하며, 정렬·필터를 통해 종목 간 빠른 비교가 가능합니다.
  </p>
</section>
"""
...
PAGES = [
    ...
    {
        "out": "web/guide/holidays.html",
        "slug": "guide/holidays",
        "title": "한국 주식 시장 휴장일 완벽 가이드",
        "subtitle": "Guide · 휴장일",
        "description": "KOSPI · KOSDAQ 정규 거래시간, 동시호가, 정기 휴장일과 단축 거래일, 휴장 전후 결제·배당락 주의점, 미국 시장과의 시차 영향까지 정리한 완벽 가이드.",
        "keywords": "주식 휴장일, KOSPI 거래시간, 동시호가, 단축 거래, 결제일, 배당락일, 권리락일, 한국거래소 캘린더",
        "body": HOLIDAY_BODY,
    },
    {
        "out": "web/guide/per-pbr-trap.html",
        "slug": "guide/per-pbr-trap",
        "title": "PER · PBR 의 함정 — 저평가 신호 vs 가치 함정",
        "subtitle": "Guide · 가치평가",
        "description": "PER · PBR 의 정확한 의미와 산업별 적정 범위, 저평가처럼 보이지만 사실은 가치 함정인 케이스 분류, PEG · ROE 와 조합한 보완 활용법까지.",
        "keywords": "PER, PBR, 가치투자, ROE, PEG, 저평가, 가치함정, value trap, 산업별 PER, 주식 평가",
        "body": PER_PBR_BODY,
    },
    {
        "out": "web/guide/foreign-vs-institution.html",
        "slug": "guide/foreign-vs-institution",
        "title": "외국인 vs 기관 — 매매 패턴 차이와 실전 활용",
        "subtitle": "Guide · 수급",
        "description": "외국인·기관 매매의 본질적 동기 차이, 시간대·종목 선호 패턴, 두 흐름 4가지 조합 해석, 실전 활용 팁과 흔한 함정까지 정리.",
        "keywords": "외국인 매매, 기관 매매, MSCI, 국민연금, 외국인 순매수, 프로그램매매, 차익거래, 동시호가",
        "body": FORINST_BODY,
    },
    {
        "out": "web/guide/preferred-vs-common.html",
        "slug": "guide/preferred-vs-common",
        "title": "우선주 vs 보통주 — 무엇을 사야 할까",
        "subtitle": "Guide · 주식 종류",
        "description": "보통주·우선주 차이, 우선주 디스카운트(괴리율) 발생 원인, 어느 쪽이 유리한 경우와 우선주 함정, 한국 시장 특이 사례(현대차2우B 등) 정리.",
        "keywords": "우선주, 보통주, 우선주 디스카운트, 괴리율, 의결권, 배당우선권, 삼성전자우, 현대차2우B, KOSPI200",
        "body": PREFERRED_BODY,
    },
    {
        "out": "web/guide/market-metrics.html",
        "slug": "guide/market-metrics",
        "title": "시가총액 · 거래대금 · 거래량 — 셋의 차이와 활용법",
        "subtitle": "Guide · 시장 지표",
        "description": "시가총액·거래량·거래대금의 정확한 정의와 차이, 회전율 계산, 어느 상황에 어느 지표를 봐야 할지, 흔한 해석 오류까지 실전 정리.",
        "keywords": "시가총액, 거래량, 거래대금, 회전율, 대형주, 중소형주, KOSPI200, 슬리피지, 유동성",
        "body": MARKET_METRICS_BODY,
    },
]
