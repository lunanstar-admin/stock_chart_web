...
밤 11시를 넘겨 블로그를 확인하니 4월 21일자 글이 없었습니다. 오늘이 화요일이라 "당일 등락률 상위 10종목" 포스트가 발행됐어야 하는 날이었는데요.
...
이 사이트는 운영자 한 명이 직접 코드를 작성·운영하고 있습니다. 새 기능을 빠르게 추가하는 일은 즐겁지만,
운영 중 발생하는 장애는 여전히 직접 로그를 열고 원인을 추적해야 합니다.

오늘 일도 그랬습니다. 로그를 열고, 숫자를 보고, 원인을 추론하고, 수정하고, 재실행 — 결국 운영자가
현상을 끝까지 이해하고 판단해야 다음 단계로 넘어갈 수 있습니다.

"배치가 90분 만에 죽었는데 원인이 뭐지?" 같은 질문이 던져진 순간부터 한 시간 만에 원인을 좁히고
패치를 배포할 수 있었다는 점이 1인 운영의 작은 장점입니다. 절차·승인이 없으니 의사결정이 빠릅니다.
다만 그만큼 모든 책임이 한 사람에게 모이니, 모니터링·알림·기록 같은 *자기 대비*가 더 중요해집니다.
